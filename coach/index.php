...
const T = {
    nl: {
        ...
        info_p_login_html: 'Coach is afgeschermd met een gedeeld wachtwoord — vraag ernaar bij de wedstrijdorganisator of kijk op de coach-poster. Geen persoonlijke accounts. Wedstrijddata komt uit de KNSB-feed en is publiek; je persoonlijke rijderslijst blijft lokaal op je telefoon.',
    ...
    en: {
        ...
        info_p_login_html: 'Coach is protected by a shared password — ask the race organiser or check the coach poster. No personal accounts. Race data comes from the KNSB feed and is publicly available; your personal skater list stays local on your phone.',
    ...
    de: {
        ...
        info_p_login_html: 'Coach ist mit einem gemeinsamen Passwort geschützt — frag den Wettkampforganisator oder schau auf das Coach-Poster. Keine persönlichen Konten. Wettkampfdaten stammen aus dem KNSB-Feed und sind öffentlich; deine persönliche Läuferliste bleibt lokal auf deinem Telefon.',
    ...
    fr: {
        ...
        info_p_login_html: 'Coach est protégé par un mot de passe partagé — demande-le à l\'organisateur de la course ou consulte l\'affiche coach. Pas de comptes personnels. Les données de course viennent du flux KNSB et sont publiques ; ta liste de skateurs personnelle reste locale sur ton téléphone.',
...
function filterDag(btn, dag) {
    ...
    container.querySelectorAll('[data-dag-nr]').forEach(el => {
        ...
        if (dag === 'alle') {
            ...
            el.classList.toggle('verborgen',
                el.getAttribute('data-dag-nr') !== String(dag));
        }
    });
}
