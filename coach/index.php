    ...
    try {
        ...
        $stmt = $pdo->prepare("
            SELECT r.volgorde AS rit_volgorde,
                   ...
                   -- distance_naam via subselect (LEFT JOIN op distances kan
                   -- 1-op-N vermenigvuldigen bij bepaalde datasets). Fallback
                   -- op r.afstand_naam als de distances-lookup niks vindt.
                   COALESCE(
