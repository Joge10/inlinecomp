...
return [
    ...
    [
        ...
        'tekst' => [
            'nl' => '🕶 <b>Publiek anoniem</b> — een rijder kan er nu zelf voor kiezen om niet met naam in de openbare pagina\'s te staan; bij jeugd regelt de ouder/verzorger dat. In plaats van naam, vereniging en woonplaats verschijnt dan <b>“Anoniem”</b>; het startnummer blijft wél staan. Eén uitzondering: van de <b>dag vóór tot en met de dag ná de wedstrijd</b> is de naam wél zichtbaar op de startlijst en de uitslag van díe wedstrijd — dan hebben rijders elkaars namen nodig om te zien in welke rit ze zitten. Daarbuiten, én in het blijvende uitslagen-archief en het serie-klassement, blijft het “Anoniem”, en de rijder is ook niet op naam te vinden via de zoekfunctie. Instellen doe je zelf via <i>Mijn InlineComp</i>, of je vraagt het aan de organisatie. Wil je dat iemand je tóch kan volgen — bijvoorbeeld je ouder of coach — dan deel je jouw persoonlijke volg-ID met die persoon; daarmee ziet hij of zij jouw naam wél.',
            'en' => '🕶 <b>Publicly anonymous</b> — a skater can now choose not to appear by name on the public pages; for youth, the parent/guardian arranges this. Instead of name, club and place of residence it shows <b>“Anonymous”</b>; the start number does stay. One exception: from the <b>day before through the day after the competition</b> the name is visible on the start list and results of that competition — that\'s when skaters need each other\'s names to see which heat they\'re in. Outside that window, and in the permanent results archive and the series standings, it stays “Anonymous”, and the skater can\'t be found by name via the search either. You set it yourself in <i>My InlineComp</i>, or ask the organisation. If you do want someone to be able to follow you — your parent or coach, say — you share your personal follow-ID with that person; that lets them see your name.',
            'de' => '🕶 <b>Öffentlich anonym</b> — ein Fahrer kann jetzt selbst wählen, nicht mit Namen auf den öffentlichen Seiten zu stehen; bei Jugendlichen regeln das die Eltern bzw. Erziehungsberechtigten. Statt Name, Verein und Wohnort erscheint dann <b>„Anonym“</b>; die Startnummer bleibt. Eine Ausnahme: vom <b>Tag vor bis zum Tag nach dem Wettkampf</b> ist der Name auf der Startliste und im Ergebnis dieses Wettkampfs sichtbar — dann brauchen die Fahrer gegenseitig ihre Namen, um zu sehen, in welchem Lauf sie sind. Außerhalb dieses Zeitraums sowie im dauerhaften Ergebnisarchiv und im Serien-Klassement bleibt es „Anonym“, und der Fahrer ist auch nicht per Namen über die Suche zu finden. Du stellst es selbst in <i>Mein InlineComp</i> ein oder fragst die Organisation. Möchtest du, dass dich jemand trotzdem verfolgen kann — etwa dein Elternteil oder Trainer — teilst du deine persönliche Verfolgungs-ID mit dieser Person; damit sieht sie deinen Namen.',
            'fr' => '🕶 <b>Anonyme en public</b> — un patineur peut désormais choisir de ne pas apparaître avec son nom sur les pages publiques ; pour les mineurs, c\'est le parent/tuteur qui s\'en charge. Au lieu du nom, du club et du lieu de résidence, il s\'affiche <b>« Anonyme »</b> ; le numéro de départ reste. Une exception : de la <b>veille au lendemain de la compétition</b>, le nom est visible sur la liste de départ et le résultat de cette compétition — c\'est le moment où les patineurs ont besoin du nom des autres pour voir dans quelle série ils se trouvent. En dehors de cette période, ainsi que dans l\'archive permanente des résultats et le classement de série, cela reste « Anonyme », et le patineur n\'est pas non plus trouvable par son nom via la recherche. Vous le réglez vous-même dans <i>Mon InlineComp</i>, ou demandez à l\'organisation. Si vous voulez que quelqu\'un puisse quand même vous suivre — votre parent ou coach, par exemple — vous partagez votre ID de suivi personnel avec cette personne ; cela lui permet de voir votre nom.',
        ],
    ],
    [
