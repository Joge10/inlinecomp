...
return [
    ...
    [
        ...
        'tekst' => [
            'nl' => '🔗 <b>Afhankelijke lotingen</b> — laat de loting van een afstand automatisch bepalen door een eerdere afstand, zonder handwerk. Kies bij het loten <i>Op afstand-uitslag</i> (bv. de puntenkoers op de uitslag van de One Lap) of <i>Op tussenklassement</i> (op de tussenstand tot dan toe). Je stelt het vooraf in; zodra de eerdere afstand bevestigd is, staat de loting er vanzelf — en bij een correctie wordt automatisch opnieuw geloot.',
            'en' => '🔗 <b>Dependent draws</b> — have a distance\'s draw made automatically from an earlier distance, no manual work. When drawing, pick <i>By distance result</i> (e.g. the points race from the One Lap result) or <i>By intermediate standings</i> (from the standings so far). Set it up in advance; once the earlier distance is confirmed the draw appears by itself — and it\'s redrawn automatically if you correct that result.',
            'de' => '🔗 <b>Abhängige Auslosungen</b> — lass die Auslosung einer Distanz automatisch aus einer früheren Distanz erstellen, ohne Handarbeit. Wähle beim Auslosen <i>Nach Distanz-Ergebnis</i> (z. B. das Punkterennen aus dem One-Lap-Ergebnis) oder <i>Nach Zwischenstand</i> (aus dem bisherigen Zwischenstand). Vorab einstellbar; sobald die frühere Distanz bestätigt ist, steht die Auslosung von selbst da — und bei einer Korrektur wird automatisch neu ausgelost.',
            'fr' => '🔗 <b>Tirages dépendants</b> — laissez le tirage d\'une distance se faire automatiquement à partir d\'une distance précédente, sans travail manuel. Au tirage, choisissez <i>Sur résultat de distance</i> (p. ex. la course aux points d\'après le résultat du One Lap) ou <i>Sur classement intermédiaire</i> (d\'après le classement en cours). À régler à l\'avance ; dès que la distance précédente est confirmée, le tirage apparaît tout seul — et il est refait automatiquement si vous corrigez ce résultat.',
        ],
    ],
    [
        'versie' => 'H1752.01.09', 'datum' => '01-09-2026', 'onderdelen' => ['admin'],
