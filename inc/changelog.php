...
return [
    ...
    [
        ...
        'tekst' => [
            ...
            'en' => '🔗 <b>Dependent draws</b> — have a distance\'s draw made automatically from an earlier distance, no manual work. When drawing, pick <i>By distance result</i> (e.g. the points race from the One Lap result) or <i>By intermediate standings</i> — where you choose after which distance the standings are taken. Set it up in advance; once that distance is confirmed the draw appears by itself — and it\'s redrawn automatically if you correct the result.',
            'de' => '🔗 <b>Abhängige Auslosungen</b> — lass die Auslosung einer Distanz automatisch aus einer früheren Distanz erstellen, ohne Handarbeit. Wähle beim Auslosen <i>Nach Distanz-Ergebnis</i> (z. B. das Punkterennen aus dem One-Lap-Ergebnis) oder <i>Nach Zwischenstand</i> — dabei wählst du selbst, nach welcher Distanz der Zwischenstand genommen wird. Vorab einstellbar; sobald diese Distanz bestätigt ist, steht die Auslosung von selbst da — und bei einer Korrektur wird automatisch neu ausgelost.',
