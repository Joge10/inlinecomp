...
//     "totaal_uniek":   aantal unieke sessies ooit (= totaal unieke bezoekers)
//     "totaal_hits":    totaal aantal page views (alle sessies opgeteld)
...
try {
    // Eén query met alle aggregaties tegelijk voor efficiency
    $stmt = $pdo->query("
        SELECT
