...
const T = {
    nl: {
        ...
        help_p_onbekend_html: 'Klik op <b>"❓ Ik vind mezelf niet in de lijst"</b> onder de namen-lijst. Vul je gegevens in (naam, gender, club, KNSB-nummer indien bekend, categorie) en wij kijken of je in het systeem staat.',
    ...
    en: {
        ...
        help_p_onbekend_html: 'Click <b>"❓ I can\'t find myself in the list"</b> below the names list. Fill in your details (name, gender, club, KNSB number if known, category) and we\'ll check whether you are in the system.',
    ...
    de: {
        ...
        help_p_onbekend_html: 'Klicke auf <b>"❓ Ich finde mich nicht in der Liste"</b> unter der Namensliste. Trage deine Daten ein (Name, Geschlecht, Verein, KNSB-Nummer falls bekannt, Kategorie) und wir prüfen, ob du im System bist.',
    ...
    fr: {
        ...
        help_p_onbekend_html: 'Cliquez sur <b>"❓ Je ne me trouve pas dans la liste"</b> sous la liste des noms. Remplissez vos données (nom, sexe, club, numéro KNSB si connu, catégorie) et nous vérifions si vous êtes dans le système.',
